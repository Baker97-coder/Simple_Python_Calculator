...
def button_click(number):
    current = number_bar.get()
    number_bar.delete(0, END)
    number_bar.insert(0, str(current) + str(number))
...
def button_equal():
    second_number = number_bar.get()
    number_bar.delete(0, END)

    if math == "addition":
        number_bar.insert(0, f_num + int(second_number))
